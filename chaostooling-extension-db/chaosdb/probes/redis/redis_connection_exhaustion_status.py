    ...
    with span_context as span:
        ...
        try:
            ...
            if span:
                ...
                span.set_attribute("chaos.activity", "redis_connection_exhaustion_status")
            ...
            connection_utilization = (connected_clients / max_clients * 100) if max_clients > 0 else 0
            ...
            logger.error(f"Redis connection exhaustion probe failed: {str(e)}", extra={"error": str(e)})
