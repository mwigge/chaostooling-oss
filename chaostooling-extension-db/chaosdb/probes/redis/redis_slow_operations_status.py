    ...
    with span_context as span:
        ...
        try:
            ...
            for entry in slowlog:
                ...
                duration_ms = entry.get("duration", 0) / 1000  # Convert microseconds to milliseconds
            ...
            avg_duration_ms = total_duration / slow_operations_count if slow_operations_count > 0 else 0
            ...
            logger.error(f"Redis slow operations probe failed: {str(e)}", extra={"error": str(e)})
