...
def probe_slow_consumer_status(
    ...
    consumer_group = consumer_group or os.getenv("KAFKA_CONSUMER_GROUP", "chaos_consumers")
    ...
    with span_context as span:
        ...
        logger.error(f"Kafka slow consumer probe failed: {str(e)}", extra={"error": str(e)})
