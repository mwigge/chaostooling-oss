"""ActiveMQ queue saturation status probe."""
...
def probe_queue_saturation_status(
    ...
    Probe to check ActiveMQ queue saturation status.
    ...
    if logger_provider:
        ...
        logger = logging.getLogger("chaosdb.activemq.activemq_queue_saturation_status")
    ...
    with span_context as span:
        ...
        try:
            ...
            if span:
                ...
                span.set_attribute("db.operation", "probe_queue_saturation")

                span.set_attribute("chaos.activity", "activemq_queue_saturation_status")
            ...
            logger.info(f"ActiveMQ queue saturation probe: {result}")
        ...
        logger.error(f"ActiveMQ queue saturation probe failed: {str(e)}", extra={"error": str(e)})
