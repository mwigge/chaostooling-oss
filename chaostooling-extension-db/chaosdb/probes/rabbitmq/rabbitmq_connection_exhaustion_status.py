...
def probe_connection_exhaustion_status(
    ...
    if logger_provider:
        ...
        logger = logging.getLogger("chaosdb.rabbitmq.rabbitmq_connection_exhaustion_status")
    ...
    with span_context as span:
        ...
        try:
            ...
            if span:
                ...
                span.set_attribute("chaos.activity", "rabbitmq_connection_exhaustion_status")
