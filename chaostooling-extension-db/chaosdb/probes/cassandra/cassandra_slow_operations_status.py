    ...
    with span_context as span:
        ...
        try:
            ...
            try:
                ...
                result = session.execute("SELECT read_latency, write_latency FROM system.local")
        ...
        logger.error(f"Cassandra slow operations probe failed: {str(e)}", extra={"error": str(e)})
