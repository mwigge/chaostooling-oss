...
def probe_query_saturation_status(
    ...
    if logger_provider:
        ...
        logger = logging.getLogger("chaosdb.cassandra.cassandra_query_saturation_status")
    ...
    with span_context as span:
        ...
        try:
            ...
            if span:
                ...
                span.set_attribute("chaos.activity", "cassandra_query_saturation_status")
        ...
        logger.error(f"Cassandra query saturation probe failed: {str(e)}", extra={"error": str(e)})
