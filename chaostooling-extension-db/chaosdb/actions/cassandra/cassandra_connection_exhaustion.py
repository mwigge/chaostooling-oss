...
def inject_connection_exhaustion(
    ...
    try:
        with tracer.start_as_current_span("chaos.cassandra.connection_exhaustion") as span:
            ...
            logger.info(f"Starting Cassandra connection exhaustion with {num_connections} connections")
