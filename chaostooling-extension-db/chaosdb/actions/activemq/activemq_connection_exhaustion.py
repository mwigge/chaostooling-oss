...
def inject_connection_exhaustion(
            ...
            span.set_attribute("chaos.operation", "connection_exhaustion")
                ...
                try:
                    ...
                    if metrics_module.activemq_connections_count_gauge:
                        metrics_module.activemq_connections_count_gauge.add(1, get_metric_tags(db_system="activemq"))
    ...
    try:
        with tracer.start_as_current_span("chaos.activemq.connection_exhaustion") as span:
            span.set_attribute("messaging.system", "activemq")
            ...
            logger.info(f"Starting ActiveMQ connection exhaustion with {num_connections} connections")
