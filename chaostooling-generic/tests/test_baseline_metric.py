...
class TestBaselineMetricInitialization:
    ...
    @pytest.mark.unit
    def test_create_with_all_fields(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_create_with_defaults(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_field_count_is_fifteen(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_immutability_fields(self, baseline_metric_factory):
...
class TestBaselineMetricThresholds:
    ...
    @pytest.mark.unit
    def test_get_thresholds_calculation(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_thresholds_with_zero_stdev(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_thresholds_with_negative_values(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_thresholds_consistency(self, baseline_metric_factory):
...
class TestBaselineMetricSerialization:
    ...
    @pytest.mark.unit
    def test_to_dict(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_to_json_serializable(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_from_dict_reconstruction(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_round_trip_preserves_data(self, baseline_metric_factory):
...
class TestBaselineMetricEdgeCases:
    ...
    @pytest.mark.unit
    def test_very_small_values(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_very_large_values(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_percentile_order(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_mean_vs_percentiles(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_count_is_positive(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_quality_score_in_range(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_baseline_window_positive(self, baseline_metric_factory):
...
class TestBaselineMetricTypeValidation:
    ...
    @pytest.mark.unit
    def test_metric_name_is_string(self, baseline_metric_factory):
        """Test that metric_name is a string."""
        metric = baseline_metric_factory(metric_name="cpu_usage")
        assert isinstance(metric.metric_name, str)

    @pytest.mark.unit
    def test_numeric_fields_are_numbers(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_sample_time_is_datetime(self, baseline_metric_factory):
        """Test that sample_time is a datetime object."""
        metric = baseline_metric_factory()
        assert isinstance(metric.sample_time, datetime)

    @pytest.mark.unit
    def test_valid_is_boolean(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_thresholds_is_dict(self, baseline_metric_factory):
...
class TestBaselineMetricComparison:
    ...
    @pytest.mark.unit
    def test_same_metrics_are_equal(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_different_metrics_not_equal(self, baseline_metric_factory):
    ...
    @pytest.mark.unit
    def test_high_quality_vs_low_quality(self, baseline_metric_factory):
...
class TestBaselineMetricSpecialCases:
    ...
    @pytest.mark.unit
    def test_constant_metric_stdev_zero(self, sample_baselines):
    ...
    @pytest.mark.unit
    def test_high_variance_metric(self, sample_baselines):
...
class TestBaselineMetricRequiredFields:
    ...
    @pytest.mark.unit
    def test_all_required_fields_present(self, baseline_metric_factory):
